...
describe('ReactElement', () => {
	...
	beforeEach(() => {
		jest.resetModules() // Delete the native Symbol if we have one to ensure we test the // unpolyfilled environment.
		...
		ReactTestUtils = require('react-dom/test-utils') // NOTE: We're explicitly not using JSX here. This is intended to test // classic JS without JSX.
	...
	}) // // NOTE: We're explicitly not using JSX here. This is intended to test // // classic JS without JSX.
